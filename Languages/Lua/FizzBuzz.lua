...
for i = 1, LOOPS do
  if (i % 15) == 0 then     -- Divisible by 3 and 5 (so 15 here) outputs "FizzBuzz"
    print("FizzBuzz")
  elseif (i % 3) == 0 then  -- Divisible by 3 outputs "Fizz"
    print("Fizz")
  elseif (i % 5) == 0 then  -- Divisible by 5 outputs "Buzz"
    print("Buzz")
